...
export default function Settings() {
  ...
  const savePanel = async () => { if (!panelForm.name || !panelForm.dataset || !panelForm.tests.length) return toast.error("Panel name, dataset and at least one test are required"); try { await api.post("/panels", panelForm); toast.success("Panel saved"); newPanel(); await load(); } catch (error) { toast.error(error?.response?.data?.detail || "Unable to save panel"); } };
