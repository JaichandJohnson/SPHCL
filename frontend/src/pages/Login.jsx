        ...
        <section className="relative hidden overflow-hidden bg-gradient-to-br from-slate-950 via-teal-900 to-cyan-800 p-12 text-white lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="relative flex items-center gap-4">
            <img
              ...
              className="h-28 w-28 rounded-full border border-white/90 bg-white object-cover p-[1px] shadow-xl scale-[1.24]"
            />
            <div>
          ...
          <div className="w-full max-w-sm">
            <div className="mb-7 flex justify-center lg:hidden">
              <img
                src={logo}
                alt="Molecular Diagnosis Section logo"
                className="h-32 w-32 rounded-full border border-white bg-white object-cover p-[1px] shadow-xl scale-[1.24]"
              />
            </div>
