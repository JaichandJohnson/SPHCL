        ...
        <section className="relative hidden overflow-hidden bg-gradient-to-br from-slate-950 via-teal-900 to-cyan-800 p-12 text-white lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="relative flex items-center gap-4">
            <img
              ...
              className="h-24 w-24 rounded-full border-4 border-white/90 bg-white object-contain shadow-xl"
            />
            <div>
          ...
          <div className="w-full max-w-sm">
            <div className="mb-7 flex justify-center lg:hidden">
              <img
                src={logo}
                alt="Molecular Diagnosis Section logo"
                className="h-28 w-28 rounded-full border-4 border-white bg-white object-contain shadow-xl"
              />
            </div>
