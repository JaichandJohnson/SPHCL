...
export default function DataEntry() {
  ...
  const saveSampleDraft = () => {
    ...
    if (
      ...
      !String(sampleDraft.sample_quality || "").trim()
    ) {
    ...
    if (
      conditionRequiredDatasets.has(sampleDraft.dataset) &&
      !String(sampleDraft.transport_condition || "").trim()
    ) {
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            >
              <Input
                ...
                onChange={(event) =>
                  updateDraft("sample_quality", event.target.value)
                }
            ...
            >
              <Input
                ...
                onChange={(event) =>
                  updateDraft("transport_condition", event.target.value)
                }
