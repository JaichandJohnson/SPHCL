...
export default function DataEntry(){
 ...
 <div className="md:col-span-2"><Field label="Sample Remarks"><Textarea rows={2} value={draft.remarks||""} onChange={e=>changeDraft("remarks",e.target.value)}/></Field></div></div><DialogFooter><Button variant="ghost" onClick={()=>setOpen(false)}>Cancel</Button><Button onClick={saveDraft}>Save Sample</Button></DialogFooter></DialogContent></Dialog>
 </div>;
}
