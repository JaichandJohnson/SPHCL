...
import sidebarLogo from "@/assets/mds-logo-sidebar.png";
...
const navItems = [
  ...
  { to: "/backup", icon: HardDrives, label: "Backup & Restore" },
];
...
export default function Layout() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-slate-50 text-slate-900">
      ...
      <div className="flex h-screen flex-col overflow-hidden lg:pl-64">
        <header className="z-20 shrink-0 border-b border-slate-200 bg-white/95 px-4 py-2 shadow-sm backdrop-blur md:px-6">
        ...
        <main className="mx-auto min-h-0 w-full max-w-[1900px] flex-1 overflow-y-auto overscroll-contain p-3 md:p-4 xl:px-5">
          <Outlet />
        </main>

        <footer className="shrink-0 border-t border-slate-200 bg-white/90 px-5 py-2 text-center text-[10px] text-slate-500">
