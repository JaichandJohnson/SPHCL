...
import logo from "@/assets/mds-logo-cropped.png";
...
const navItems = [
  ...
  { to: "/import", icon: UploadSimple,
  CloudArrowUp, label: "Bulk Import" },
  { to: "/settings", icon: Gear, label: "Master Data" },
  { to: "/backup", icon: CloudArrowUp, label: "Backup Status" },
];
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="border-b border-slate-100 bg-gradient-to-br from-slate-950 via-slate-900 to-teal-900 px-5 py-6 text-white">
          <div className="flex items-center gap-3">
            <img
              ...
              className="h-20 w-20 rounded-full border-[1px] border-white bg-white object-cover shadow-lg"
            />
            <div>
      ...
      <div className="lg:pl-64">
          ...
          <div className="mx-auto flex max-w-[1500px] items-center justify-between gap-4">
            <div className="flex min-w-0 items-center gap-3">
              <img
                src={logo}
                alt=""
                className="h-14 w-14 shrink-0 rounded-full border-[1px] border-white bg-white object-cover shadow-md lg:hidden"
              />
              <div className="min-w-0">
        ...
        <footer className="border-t border-slate-200 bg-white/70 px-5 py-4 text-center text-xs text-slate-500">
          © 2026 State Public Health &amp; Clinical Laboratory, Trivandrum, Trivandrum.
        </footer>
      </div>
